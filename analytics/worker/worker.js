export default { async fetch(request, env) {
  ...
  if (request.method !== "POST" || url.pathname !== "/v1/analytics") return new Response("Not found", {status: 404});
  ...
  try { return await fetch(`${env.ORIGIN}/v1/analytics`, {method:"POST", headers, body:request.body, signal:AbortSignal.timeout(5000)}); }
