...
export type Dialog =
  ...
  | { kind: "file-send" } | { kind: "file-confirm"; paths: string[]; source: FileConfirmSource; image?: PendingImage } | { kind: "file-list"; files: FileTransfer[] } | { kind: "file-download"; fileId: string; filename: string; filePath: string }
