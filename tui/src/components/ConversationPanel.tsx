...
export function ConversationPanel(props: ConversationPanelProps) {
  ...
  return <box style={{ flexGrow: 1, flexShrink: 1, minHeight: 0, flexDirection: "column", gap: 1 }}>
    ...
    {typingNames.length > 0 && <text fg="#7aa2d6">{typingNames.length === 1 ? `${typingNames[0]} is typing...` : typingNames.length === 2 ? `${typingNames[0]} and ${typingNames[1]} are typing...` : "Multiple people are typing..."}</text>}
